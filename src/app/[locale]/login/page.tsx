                ...
                {!isMobile ? (
                    <>
                        <motion.div
                            ...
                            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-primary/20 to-secondary/20 rounded-full blur-3xl"
                        />
                        <motion.div
                            animate={{
                                scale: [1.2, 1, 1.2],
                            ...
                            className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full blur-3xl"
                        />
                    </>
                ) : (
                    // Static background for mobile
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-gradient-to-r from-primary/10 to-secondary/10 rounded-full blur-2xl" />
                )}
            </div>
                        ...
                        {error && (
                            ...
                            >
                                <p className="text-sm text-red-500">
                                    {(() => {
                                        const axiosError = error as { response?: { data?: { details?: string; title?: string }; status?: number } };
